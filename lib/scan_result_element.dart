...
class ScanResultElement extends StatefulWidget {
  const ScanResultElement({super.key, required this.result, this.onTap});

  final ScanResult result;
  final VoidCallback? onTap;

  @override
  State<ScanResultElement> createState() => _ScanResultElementState();
}

class _ScanResultElementState extends State<ScanResultElement> {
